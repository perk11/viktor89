...
class InternalMessage
{
    ...
    // Raw image bytes for a photo that exists only in the current turn (e.g. an
    // image just generated by a tool call, before it is re-read back from the
    // database). Not persisted: lets list_chain_images / image references see
    // freshly generated images without a Telegram file id.
