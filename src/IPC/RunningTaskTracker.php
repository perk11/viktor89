    ...
    public function receive(Execution $execution): void
    {
        ...
        while (true) {
            try {
                ...
                // worker, so a stale draft or edit could appear after later
                // messages — and, because its workerDrafts entry is never removed,
                // block cleanupChat for the whole chat for every later worker too.
                if ($workerId !== null) {
