...
class PersonaAwareSystemPromptReaderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userPreferenceRepository = new UserPreferenceRepository($this->database);
    ...
    public function testDeletedPersonaIsIgnored(): void
    {
        $this->personaRepository->addPersona('pirate', 'You are a pirate.', 999, 'Bob');
        $this->userPreferenceRepository->writeUserPreference(111, PersonaHelper::PERSONA_PREFERENCE, 'pirate');
        $this->personaRepository->deletePersonaByName('pirate');
    ...
    private function createReader(?string $systemPromptValue): PersonaAwareSystemPromptReader
    {
        ...
        return new PersonaAwareSystemPromptReader($this->userPreferenceRepository, $this->personaRepository, $systemPromptProcessor);
    }
}
