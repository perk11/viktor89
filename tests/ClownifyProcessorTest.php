...
#[CoversClass(\Perk11\Viktor89\ImageGeneration\ClownifyProcessor::class)]
class ClownifyProcessorTest extends TestCase
{
    ...
    public function testHasConstructorWithThreeParameters(): void
    {
        $reflection = new \ReflectionClass(\Perk11\Viktor89\ImageGeneration\ClownifyProcessor::class);
