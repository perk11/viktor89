...
#[CoversClass(\Perk11\Viktor89\Audio\AudioRepository::class)]
class AudioRepositoryTest extends TestCase
{
    public function testIsClass(): void
    {
        $reflection = new \ReflectionClass(\Perk11\Viktor89\Audio\AudioRepository::class);
    ...
    public function testHasSaveMethod(): void
    {
        ...
        $this->assertSame('extension', $params[3]->getName());
    }
    ...
    public function testHasFindAllPublicAudiosMethod(): void
    {
        $reflection = new \ReflectionClass(\Perk11\Viktor89\Audio\AudioRepository::class);
        $method = $reflection->getMethod('findAllPublicAudios');
        $returnType = $method->getReturnType();
